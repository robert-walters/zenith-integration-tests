post_candidate_activity_schema = {
    ...
    "properties": {
        ...
        "outcome": {
            "type": ["string", "null"],
            "enum": [None, "event_did_not_happen", "wrong_entry", "bb_candidate_green_flagged", "bb_candidate_amber_flagged",
                     "reject", "none"]
        ...
        "source": {
            "type": ["string", "null"],
            "enum": [None, "LINKEDIN", "LINKEDIN_SOCIAL", "ROBERTWALTERS_BE", "ROBERTWALTERS_FR", "ROBERTWALTERS_DE",
