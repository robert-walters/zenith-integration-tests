...
def update_job_activity_required_fields_payload():
    return {
...
def update_job_activity_full_payload():
    return {
...
def update_job_activity_original_mandatory_payload(job_id):
    return {
        "responsible_user_id": get_user_id_from_core_api(),
        "responsible_team_id": get_team_id_from_core_api(),
        "type": random_job_activity_type(),
...
def update_job_activity_original_full_payload(job_id):
    return {
        "email_id": get_email_id_core_api(),
        "outcome": random_activity_outcome(),
        "outcome_date": get_today_date(),
